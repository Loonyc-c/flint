 ...
 * Currently displays mocked UI elements.
 */
const MatchingPref = () => (
    ...
    <div className="w-full max-w-160 bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-2xl shadow-sm p-6 sm:p-8 md:p-10 flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="w-full px-2">
          ...
          <div className="relative w-full h-1 bg-gray-200 rounded-full">
            <div className="absolute left-1/4 right-1/4 h-full bg-[#D9776D] rounded-full" />
            <div className="absolute left-1/4 top-1/2 -translate-y-1/2 w-4 h-4 bg-[#D9776D] rounded-full shadow border-2 border-white" />
            <div className="absolute right-1/4 top-1/2 -translate-y-1/2 w-4 h-4 bg-[#D9776D] rounded-full shadow border-2 border-white" />
          </div>
      ...
      <div className="w-full flex items-center justify-between pt-2 pb-4 border-b border-gray-200 dark:border-neutral-700">
        ...
        <div className="flex gap-2">
          <div className="px-3 py-1 rounded-full bg-brand text-white text-sm">Everyone</div>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3 text-neutral-900 dark:text-neutral-100">
          ...
          <span className="text-base sm:text-lg font-medium">Maximum Distance</span>
        </div>

        <div className="flex flex-col gap-2">
          <div className="flex justify-between items-center text-sm sm:text-base text-neutral-800 dark:text-neutral-200">
            <span>Distance</span>
            <span className="font-semibold text-brand">{MAX_DISTANCE} km</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 mt-1">
            Show me people within {MAX_DISTANCE} km from my location
          </p>
        </div>
      </div>
    </div>
