import { z } from "zod";
import { profileUpdateSchema } from "@/shared-types/validations";
...
export const formSchema = profileUpdateSchema
  ...
  .extend({
    ...
    instagram: z
      ...
      .max(50, "Instagram username too long"),
    voiceIntroFile: z.union([z.instanceof(Blob), z.string()]).optional(),
    questions: z
      .array(questionAnswerFormSchema)
      .length(3, "Please complete all 3 questions"),
  })
