      ...
      <div className="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={onClose}
              className="flex items-center justify-center transition-colors rounded-full w-9 h-9 hover:bg-neutral-100 dark:hover:bg-neutral-800"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="pr-2 space-y-6 overflow-y-auto">
            {Object.entries(
              ...
              <div key={category} className="space-y-2">
                <h4 className="px-1 text-xs font-bold tracking-widest uppercase text-neutral-400">
                  {category}
                </h4>
