...
const ActionButton = ({
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 ${v.glow} transition-colors duration-300`} />
...
// Keyboard hint badge
const KeyHint = ({ keys, label, color }: { keys: string; label: string; color: string }) => (
  <motion.div 
...
export const SwipeControls = ({ onSwipe, onUndo, canUndo, isSwiping }: SwipeControlsProps) => {
  return (
